...
코로나 시대는 우리의 많은 것을 바꿔놓았습니다. 가정에서 많은 시간을 보내던 우리의 일상에는 자연스레 **_독서_**가 자리 잡았고, 모바일로 모든걸 해결 할 수 있는 시대에 있는 지금 종이책보다 **eBook** 등의 전자책 시장이 급속도로 커지게 되었습니다.
...
**_이렇게 우리는 작가와 독자를 이어주는 중개이자 플랫폼으로써 여러분의 소중한 이야기를 담은 서비스_ `소나기 (소중한 나의 이야기)`_를 운영해보려 합니다._**
</br>
